...
This wiki is hosted on [GitHub](https://github.com/MindustryGame/wiki). If you would like to edit something, simply click the edit button at the top of a page, and you will be directed to a *pull request* form, where you can make your changes and submit them for approval. Note that the majority of the wiki is *autogenerated*, meaning that you should open a Pull Request on the [WikiGen repository](https://github.com/Anuken/Mindustry-Wiki-Generator) if the issue concerns those pages.
